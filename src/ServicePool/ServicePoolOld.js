...
//     // Pre-fill form with existing data for reopening
//     const historyData = historyResponse.data || [];
//     const assignmentHistory = Array.isArray(historyData) 
//       ? historyData.find(history => history.request === request.request_id)
//       : null;
    
//     // Find the engineer resource ID from the assignment history
//     const engineerResource = resources.find(r => r.resource_id === request.assigned_engineer);
    
//     setFormData({
//       engineerId: engineerResource ? engineerResource.user : "",
//       completionTime: request.estimated_completion_time ? 
//         `${Math.floor(request.estimated_completion_time)}:${Math.floor((request.estimated_completion_time % 1) * 60)}` : "",
...
//       est_start_datetime: formData.startDateTime,
//       est_end_datetime: formData.endDateTime,
//       status: isReopening ? "Reopened" : "Assigned",
//       company: selectedCompany,
//       user_id: userId,
//       company_id: selectedCompany,
//     };
...
//     status: isReopening ? "Pending" : "Pending",
//           decline_reason: "",
//       comments: "",
//       created_by: userId,
//       updated_by: userId,
...
//         icon: 'success',
//         title: 'Success!',
//         text: isReopening ? 'Service request reopened successfully!' : 'Service request assigned successfully!',
//         confirmButtonColor: '#3085d6',
//       });
...
//       Swal.fire({
//         icon: 'error',
//         title: isReopening ? 'Reassign Failed' : 'Assignment Failed',
//         text: errorMessage,
//         confirmButtonColor: '#3085d6',
//       });
//     }
...
//       Assign
//     </button>
//   ) : item.status === "Closed" && engineerStatus === "Accepted" ? (
//     <button
...
//           <div className="card">
//             <div className="card-header">
//               <h3>{isReopening ? 'Reopen Service' : 'Service Assignment'} for {currentRequest?.request_id}</h3>
//               <p>Fill in the {isReopening ? 'reopening' : 'assignment'} details below</p>
//             </div>
