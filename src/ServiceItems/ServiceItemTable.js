...
import { useNavigate } from 'react-router-dom';
import './NewServiceItem.css';
import { FaEdit, FaTrash, FaFileContract, FaExternalLinkAlt, FaEye } from 'react-icons/fa';
import axios from 'axios';
import baseURL from '../ApiUrl/Apiurl';
  ...
  const handleViewContract = (item) => {
    ...
    if (!latestContract) {
      ...
      Swal.fire({
        ...
        text: 'This service item does not have any contract yet.',
      });
      return;
    }
