...
const PMGroupTable = ({
  ...
  return (
    <>
      ...
      {searchTerm && (
        <div className="alert alert-info mb-3">
          <strong>Search Results:</strong> Found {totalCount} PM group(s) matching "{searchTerm}"
        </div>
      )}
            ...
            {fetching ? (
              <tr>
                <td colSpan="9" className="text-center py-4">
                  ...
                  <p className="mt-2 mb-0 text-muted">Loading PM groups...</p>
                </td>
              </tr>
            ) : pmGroups.length > 0 ? (
              ...
              <tr>
                <td colSpan="9" className="text-center py-4">
                  <div className="text-muted">
                    <p className="mb-0">
                      {searchTerm 
                        ? `No PM groups found matching "${searchTerm}"` 
                        : 'No PM groups found.'}
                    </p>
                  </div>
                </td>
      ...
      {totalCount > 0 && (
        <div className="text-center text-muted mt-2">
          <small>Showing {pmGroups.length} of {totalCount} PM groups</small>
        </div>
      )}
    </>
  );
